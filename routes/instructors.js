...
Instructor = require('../models/instructors');
...
router.post('/classes/register',function(req,res){
  ...
  //in classes /details.handlebars there is hidden form., class_title is coming form  there only.
  info['class_title'] = req.body.class_title;
  console.log("class_title is  :"+req.body.class_title);
...
router.get('/classes/:id/lessons/new',function(req,res,next){
  ...
  router.post('/classes/:id/lessons/new',function(req,res,next){
    var info=[];
      ...
      req.flash('success_msg','Lesson Addeed');
      res.redirect('/instructors/classes');
    });
